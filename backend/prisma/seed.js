  ...
  const seedData = [
    ...
    prisma.pages.upsert({
      ...
      create: {
        ...
        data: JSON.stringify({
          photo: fs
            .readFileSync(path.join(__dirname, "assets", "photo.png"))
            .toString("base64"),
          description:
            "Hello! I'm Muhamad Ajib Firdaus, a passionate web programmer with a knack for creating dynamic and user-friendly websites.",
          description2:
            "With a strong foundation in both front-end and back-end development, I have honed my skills to deliver high-quality digital solutions that meet the needs of clients and users alike.",
        }),
      },
    }),
    prisma.pages.upsert({
          ...
          projects: [
            {
              ...
              image: fs
                .readFileSync(
                  path.join(__dirname, "assets", "absensi-smkn4.png")
                )
                .toString("base64"),
            },
            {
              ...
              image: fs
                .readFileSync(path.join(__dirname, "assets", "growtovia.png"))
                .toString("base64"),
            },
          ],
        }),
